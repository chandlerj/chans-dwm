...
static const char *fonts[]          = { "DM Mono:size=11" };
static const char dmenufont[]       = "DM Mono:size=10";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_deepblue, "-sf", col_gray4, "-c" };
